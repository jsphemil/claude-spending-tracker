  ...
  return (
    <div className="max-w-md p-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-semibold text-zinc-900">Fixed Commitments</h1>
      ...
      <div className="mt-4 rounded-lg border border-zinc-200 bg-white p-4">
        ...
        <p className="text-2xl font-semibold text-rose-700">{formatMoney(totalCommitmentMonthly, "INR")}/mo</p>
      ...
      {rows.length === 0 ? (
        ...
        <>
          {[
            { title: "Recurring Expenses", rows: expenseRows, color: "text-rose-700" },
            { title: "Recurring Transfers & Investments", rows: transferRows, color: "text-blue-700" },
            { title: "Recurring Income (for reference)", rows: incomeRows, color: "text-emerald-700" },
          ]
