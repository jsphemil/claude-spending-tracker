...
export function ClaudeFabPlaceholder() {
  return (
    <button
      ...
      className="fixed bottom-20 right-4 z-40 flex h-12 w-12 cursor-not-allowed items-center justify-center rounded-full bg-surface-3 text-fg-subtle shadow-lg md:bottom-6"
    >
